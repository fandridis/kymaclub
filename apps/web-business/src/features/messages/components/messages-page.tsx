...
function MessageThreadRow({ thread, onThreadClick, isSelected }: MessageThreadRowProps) {
    ...
    return (
        <div
            className={`p-4 border-b border-border hover:bg-muted/50 cursor-pointer transition-colors ${isSelected ? 'bg-muted border-r-2 border-r-primary' : ''
                }`}
    ...
    return (
        <div className="h-full flex flex-col">
            <div className="flex-1 flex overflow-hidden">
                ...
                <div className={`${isMobileConversationView ? 'hidden' : 'flex'
                ...
                <div className={`${isMobileConversationView ? 'flex' : 'hidden md:flex'
                    } flex-1 flex-col`}>
