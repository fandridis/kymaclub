...
function ClassTemplatesList({ templates }: {
  templates?: Array<Doc<"classTemplates">>
}) {
...
function ClassInstancesList({ instances, templates }: {
  instances?: Array<Doc<"classInstances">>,
  templates?: Array<Doc<"classTemplates">>
}) {
  ...
  return (
    <div className="space-y-2">
      {instances.map((instance) => {
        ...
        const name = instance.name || instance.templateSnapshot.name || template?.name || 'Unnamed Class';
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-1.5">
                    ...
                    <span className={`text-xs font-mono px-2 py-0.5 rounded border ${getStatusColor(instance.status as string)}`}>
...
function EarningsList({ earnings }: {
  earnings?: Array<Doc<"creditTransactions">>
}) {
